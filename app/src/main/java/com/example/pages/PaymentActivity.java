...
import com.example.tools.GooglePayUtil;
...
public class PaymentActivity extends AppCompatActivity {
    ...
    private static final long SHIPPING_COST_CENTS = 90 * GooglePayUtil.CENTS_IN_A_UNIT.longValue();
...
//    }
    ...
    public void requestPayment(View view) {
        ...
        try {
            ...
            long garmentPriceCents = Math.round(garmentPrice * GooglePayUtil.CENTS_IN_A_UNIT.longValue());
            long priceCents = garmentPriceCents + SHIPPING_COST_CENTS;

            Optional<JSONObject> paymentDataRequestJson = GooglePayUtil.getPaymentDataRequest(priceCents);
